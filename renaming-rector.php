...
return static function (RectorConfig $rectorConfig): void {
    ...
    $rectorConfig->ruleWithConfiguration(RenameStaticMethodRector::class, [
        new RenameStaticMethod('Text', '_', 'Joomla\CMS\Language\Text', '_'),
        new RenameStaticMethod('Text', 'sprintf', 'Joomla\CMS\Language\Text', 'printf'),
        new RenameStaticMethod('Text', 'plural', 'Joomla\CMS\Language\Text', 'plural'),
        new RenameStaticMethod('JText', '_', 'Joomla\CMS\Language\Text', '_'),
        new RenameStaticMethod('JText', 'sprintf', 'Joomla\CMS\Language\Text', 'printf'),
        new RenameStaticMethod('JText', 'plural', 'Joomla\CMS\Language\Text', 'plural'),
    ]);
